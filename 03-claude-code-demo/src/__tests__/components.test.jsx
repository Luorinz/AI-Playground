...
import { createEmptyBoard, createPiece, BOARD_WIDTH, BOARD_HEIGHT } from '../game/gameLogic.js'
...
describe('ScorePanel 组件', () => {
  it('显示分数、行数与等级', () => {
    render(<ScorePanel score={1200} lines={5} level={2} next="I" status="playing" />)
  ...
  it('暂停时显示暂停徽标', () => {
    render(<ScorePanel score={0} lines={0} level={1} next="I" status="paused" />)
    expect(screen.getByText('已暂停')).toBeInTheDocument()
  })

  it('非暂停状态不显示暂停徽标', () => {
    render(<ScorePanel score={0} lines={0} level={1} next="I" status="playing" />)
